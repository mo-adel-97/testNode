    ...
    try {
      ...
      console.error('Error:', error.message);
        ...
        try {
          ...
          const browserPhone = await puppeteer.launch({ headless: true });
          const pagePhone = await browserPhone.newPage();
          ...
          const screenshotBufferMobile = await pagePhone.screenshot();
